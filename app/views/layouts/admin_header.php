...
<head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/css/admin-style.css?v=2.0">
            ...
            <div class="sidebar-content-wrapper">
                 <nav>
                    <div class="sidebar-section">
                        <a href="<?= BASEURL; ?>/admin/dashboard" class="sidebar-item" id="nav-dashboard-admin">
                        ...
                        <a href="<?= BASEURL; ?>/admin/pengguna/staff" class="sidebar-item" id="nav-pengguna-admin">
                            <span class="sidebar-icon-wrapper">
                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            </span>
                            <span>Manajemen Pengguna</span>
                        </a>
                        <a href="<?= BASEURL; ?>/admin/barang" class="sidebar-item" id="nav-barang-admin">
                            <span class="sidebar-icon-wrapper">
                         ...
                         <a href="<?= BASEURL; ?>/admin/kelas" class="sidebar-item" id="nav-kelas-admin">
                            <span class="sidebar-icon-wrapper">
                                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" fill="currentColor"><path d="M0 0h24v24H0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-5-9.5V13h10v-2.5h-10zm0-3V8h10v2h-10zm0 6V18h10v-2h-10z"/></svg>
                            </span>
                            <span>Manajemen Kelas</span>
                        </a>
                        <a href="<?= BASEURL; ?>/admin/laporan" class="sidebar-item" id="nav-laporan-admin">
                            <span class="sidebar-icon-wrapper">
                    ...
                    <div class="sidebar-section">
                        <a href="<?= BASEURL; ?>/admin/profile" class="sidebar-item" id="nav-profile-admin">
                            <span class="sidebar-icon-wrapper">
