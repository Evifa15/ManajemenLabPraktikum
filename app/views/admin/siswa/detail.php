...
<?php
    // Tentukan URL kembali berdasarkan parameter 'origin'
    $kembaliUrl = BASEURL . '/admin/pengguna/siswa'; // Default URL
    if (isset($data['origin']) && $data['origin'] === 'kelas' && isset($data['kelas_id'])) {
        $kembaliUrl = BASEURL . '/admin/detailKelas/' . $data['kelas_id'];
    }
?>
<a href="<?= $kembaliUrl; ?>" class="link-kembali">
